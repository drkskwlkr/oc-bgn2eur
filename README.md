...
**Забележка:** Автоматично премахва флага за конверсия, позволявайки повторно изпълнение.
...
#### `reset`
Премахва флага за конверсия без да възстановява данните.
...
- **Конверсията може да се изпълни само веднъж** - скриптът задава флаг в базата данни, който предотвратява повторно изпълнение
- Командата `restore` автоматично премахва флага и позволява повторна конверсия след възстановяване
